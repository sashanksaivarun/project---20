...
fan2 = Bodies.rectangle(396,350,130,20,fan1_options);
World.add(world,fan2);

fan3 = Bodies.rectangle(105,350,130,20,fan1_options);
...
function draw() {
  ...
  rect(fan2.position.x,fan2.position.y,130,20);
  rect(fan3.position.x,fan3.position.y,130,20)
